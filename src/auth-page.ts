...
<title>Đăng nhập HICAS CXM MCP</title>
<style>
...
</style></head><body><main class="card"><div class="brand">HICAS CXM MCP</div><h1>Đăng nhập để cấp quyền cho MCP</h1>${notice}${content}</main></body></html>`;
}
